package com.bpmlinks.vbank.helper.speedview
...
abstract class Gauge constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr),
    ...
    private fun init() {
        ...
        sections.add(Section(0f, .6f, 0xFF1dc5d4.toInt(), speedometerWidth).inGauge(this))
        sections.add(Section(.6f, .87f, 0xFF1dc5d4.toInt(), speedometerWidth).inGauge(this))
        sections.add(Section(.87f, 1f, 0xFF1dc5d4.toInt(), speedometerWidth).inGauge(this))
