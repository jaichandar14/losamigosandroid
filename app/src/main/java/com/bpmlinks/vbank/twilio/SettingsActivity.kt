...
class SettingsActivity : AppCompatActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            setupCodecListPreference(AudioCodec::class.java, PREF_AUDIO_CODEC, PREF_AUDIO_CODEC_DEFAULT, findPreference<ListPreference>(PREF_AUDIO_CODEC) )
            setupCodecListPreference(VideoCodec::class.java, PREF_VIDEO_CODEC, PREF_VIDEO_CODEC_DEFAULT, findPreference<ListPreference>(PREF_VIDEO_CODEC))
            setupSenderBandwidthPreferences(PREF_SENDER_MAX_AUDIO_BITRATE, PREF_SENDER_MAX_AUDIO_BITRATE_DEFAULT, findPreference<EditTextPreference>(PREF_SENDER_MAX_AUDIO_BITRATE) )
            setupSenderBandwidthPreferences(PREF_SENDER_MAX_VIDEO_BITRATE, PREF_SENDER_MAX_VIDEO_BITRATE_DEFAULT, findPreference<EditTextPreference>(PREF_SENDER_MAX_VIDEO_BITRATE) )
        }
