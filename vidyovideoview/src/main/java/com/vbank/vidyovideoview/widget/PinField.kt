...
open class PinField : AppCompatEditText {
    ...
    var fieldColor = ContextCompat.getColor(context,
        R.color.black
    )
        set(value) {
            field = value
    ...
    var highlightPaintColor = ContextCompat.getColor(context,
        R.color.highlighted_box_color
    )
        set(value) {
            field = value
    ...
    var fieldBgColor =  ContextCompat.getColor(context,
        R.color.black
    )
        set(value){
            field = value
    ...
    private fun initParams(attr: AttributeSet) {
        ...
        try {
            ...
            distanceInBetween = a.getDimension(
                R.styleable.PinField_distanceInBetween,
                DEFAULT_DISTANCE_IN_BETWEEN
            )
